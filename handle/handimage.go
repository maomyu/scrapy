...
var (
	...
	imgFileName       = "./pic/%s.png"
	imgFileNameQrCode = "./pic/qr/%s.jpg"
...
func calcImage(poem db.Poem) (imgBean bean.ImageBean, err error) {
	...
	resultContent = append(resultContent, poem.Auther+" "+poem.Dynasty)
...
func CreateShiImage(poem db.Poem) {
	...
	fileName := poem.Auther + "_" + strings.Replace(poem.Title, "/", "", -1)
